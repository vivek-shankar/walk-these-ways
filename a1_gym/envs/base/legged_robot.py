...
from a1_gym.envs.base.base_task import BaseTask
from a1_gym.utils.math_utils import quat_apply_yaw, wrap_to_pi, get_scale_shift
from a1_gym.utils.terrain import Terrain
...
class LeggedRobot(BaseTask):
    ...
    def _init_buffers(self):
        ...
        if self.cfg.control.control_type == "actuator_net":
            actuator_path = f'{os.path.dirname(os.path.dirname(os.path.realpath(__file__)))}/../../resources/actuator_nets/unitree_a1.pt'
    ...
    def _prepare_reward_function(self):
        ...
        """
        # reward containers
        from a1_gym.envs.rewards.corl_rewards import CoRLRewards
