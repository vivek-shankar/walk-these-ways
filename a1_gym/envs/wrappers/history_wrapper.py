...
if __name__ == "__main__":
    ...
    from a1_gym_learn.ppo import Runner
    from a1_gym.envs.wrappers.history_wrapper import HistoryWrapper
    from a1_gym_learn.ppo.actor_critic import AC_Args

    from a1_gym.envs.base.legged_robot_config import Cfg
    from a1_gym.envs.mini_cheetah.mini_cheetah_config import config_mini_cheetah
